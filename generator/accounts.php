...
<?php include("noob/header.php"); ?>
         ...
         <div class="col-md-6 grid-margin">
              <div class="card">
                <div class="card-body">
                  <center><h4 class="card-title">Our Accounts</h4></center>
                  
                  
                    <div class="table-sorter-wrapper col-md-6 table">
...
<td>
<h4>
<span class="fw-semi-bold"><b>'.$row[name].'</b> </span>
&nbsp;<b><a target="_blank" href="'.$row['link'].'"></b><i class="fas fa-link text-danger" aria-hidden="true"></i></a>
<b><span style="font-size: 13px" class="label label-'.$row['stockcolor'].' pull-right">'.$row['stock'].'</span></b>
</h4>
<p><b>'.$row[about].'</b></p>
</td>
</tr>
	';
              ...
              <div class="card">
                <div class="card-body">
                  <center><h4 class="card-title">Our Private Accounts</h4></center>
...
<h4>
<span class="fw-semi-bold"><b>'.$row['name'].'</b></span>
&nbsp;<b><a target="_blank" href="'.$row['link'].'"></b><i class="fas fa-link text-success" aria-hidden="true"></i></a>
<b><span style="font-size: 13px" class="label label-'.$row['stockcolor'].' pull-right">'.$row['stock'].'</span></b>
</h4>
<p><b>'.$row[about].'</b></p>
</td>
